...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-[calc(100vh-200px)] flex items-center justify-center bg-gradient-to-br from-primary-50 via-white to-accent-50 py-8 px-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-card p-6 sm:p-8">
          <h2 className="text-xl sm:text-2xl font-bold text-neutral-900 mb-1 sm:mb-2">Create Account</h2>
          <p className="text-neutral-500 mb-4 sm:mb-6 text-sm sm:text-base">Join Grawizah and start trading globally</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
            ...
            <Button
              ...
              className="w-full"
              loading={loading}
              disabled={!allValid && password.length > 0}
            >
              Create Account
            </Button>
          </form>
          ...
          <div className="grid grid-cols-3 gap-3">
            <button className="flex items-center justify-center p-3 border border-neutral-200 rounded-lg hover:bg-neutral-50 transition-colors">
        ...
        {/* Sign in link */}
        <p className="text-center mt-4 sm:mt-6 text-neutral-600 text-sm">
