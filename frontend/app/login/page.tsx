    ...
    <div className="min-h-[calc(100vh-200px)] flex items-center justify-center bg-gradient-to-br from-primary-50 via-white to-accent-50 py-8 px-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-card p-6 sm:p-8">
          <h2 className="text-xl sm:text-2xl font-bold text-neutral-900 mb-1 sm:mb-2">Welcome Back</h2>
          <p className="text-neutral-500 mb-4 sm:mb-6 text-sm sm:text-base">Sign in to your account to continue</p>
